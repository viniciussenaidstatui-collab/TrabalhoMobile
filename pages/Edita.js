...
export default function AlteraItem({ navigation }) {
  ...
  const { produto } = route.params || {}; // Recebe o produto da tela anterior
  ...
  useEffect(() => {
    if (produto) {
      ...
      Alert.alert(
        'Erro',
        'Nenhum produto selecionado para editar',
...
async function handleAtualizar() {
  ...
  console.log('📤 Dados:', { id_loja: id, aparelho, modelo, cor, ano: anoNumero });
  ...
  try {
    const response = await axios.put(
      ...
      {
        id_loja: id,        // ← CORRIGIDO: usando id_loja
          ...
          >
            <View style={styles.container}>
              ...
              <View style={styles.form}>
                ...
                <TouchableOpacity
                  style={[styles.btnAtualizar, loading && styles.btnDisabled]}
